...
class LookUpData:
    ...
    def load_property(self, property):
        ...
        try:
            ...
            raise IOError("File {} doesn't exist!!! Please make sure you specify the correct file name".format(file))
    ...
    def load_special_property(self, property):
        ...
        try:
            ...
            print("File {} doesn't exist!!! Please make sure you specify the correct file name".format(file))
            sys.exit(1)
        else:
            for line in prop_file.readlines():
                words = line.strip().split()
